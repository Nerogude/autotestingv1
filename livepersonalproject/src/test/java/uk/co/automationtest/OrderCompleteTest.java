...
public class OrderCompleteTest extends Hooks {
	...
	public void endToEndTest() throws InterruptedException, IOException {
		...
		// creating an object of the uk.co.automationtest webpage
		...
		pInfo.getFirstNameField().sendKeys("Johnny");
		pInfo.getLastnameField().sendKeys("Smithy");
		pInfo.getEmailField().sendKeys("johnnysmith@test.com");
